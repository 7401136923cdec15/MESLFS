...
import com.mes.lfs.server.service.CoreService;
import com.mes.lfs.server.service.mesenum.QRTypes;
import com.mes.lfs.server.service.po.APIResult;
import com.mes.lfs.server.service.po.bfc.BFCMessage;
import com.mes.lfs.server.service.po.bms.BMSEmployee;
import com.mes.lfs.server.service.po.dms.DMSLedgerStatus;
import com.mes.lfs.server.service.po.fmc.FMCWorkspace;
import com.mes.lfs.server.service.po.sch.SCHWorker;
...
public class CoreServiceImpl implements CoreService {
	...
	@Override
	public APIResult FMC_QueryLineUnitList(BMSEmployee wLoginUser, int wLineID) {
		APIResult wResult = new APIResult();
		try {
			Map<String, Object> wParms = new HashMap<String, Object>();
			wParms.put("LineID", wLineID);
