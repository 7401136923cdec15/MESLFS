...
public class FMCResource implements Serializable {
	...
	public FMCResource Clone() {
		FMCResource wItem = new FMCResource();
		wItem.ID = this.ID;
		...
		wItem.Status = this.Status;
		wItem.StationList = new ArrayList<FMCStation>(this.StationList);
		return wItem;
	}
}
